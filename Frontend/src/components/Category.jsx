const Category = () => {
  return (
    <div className="flex items-center m-3 ">
      ...
      {/* - bg-gradient-to-t → creates a background gradient that flows to the top (so the color starts at the bottom and fades upward).
  - from-black/50 → the gradient starts with black at 50% opacity.
